...
test.page("http://localhost:9888/admin/register")("Empty email, throwas error", async t =>{
    await t
...
test.page("http://localhost:9888/admin/register")("Empty name, throwas error", async t =>{
    await t
        .click("#app > div > form > button")
...
test.page("http://localhost:9888/admin/register")("Empty password, throwas error", async t =>{
    await t
        .click("#app > div > form > button")
...
test.page("http://localhost:9888/admin/register")("Empty password, throwas error", async t =>{
    await t
        ...
        .click("#app > div > form > button")
        .expect(Selector("#app > div > form > button").innerText).eql("Login")
})
